...
def parse_args():
    p = argparse.ArgumentParser(description="Train with AdamW")
    ...
    p.add_argument("--weight-decay", type=float, default=0.0, help="Weight decay (decoupled)")
...
def main():
    ...
    run_dir = os.path.join("runs", "adamw", args.dataset, f"seed_{args.seed}")
    ensure_dir(run_dir)
